...
public class ApparentLossController {
    ...
    @ResponseBody
	public String queryALOverviewData() {
		return null;
	}
    ...
    @ResponseBody
	public String queryMeterRunAnalysisList() {
		return null;
	}
    ...
    @ApiOperation(value = "查询水表运行分析列表数据", notes = "查询水表运行分析列表数据", httpMethod = "POST", response = MessageBean.class, consumes = "application/json;charset=UTF-8", produces = "application/json;charset=UTF-8")
    @ResponseBody
	public String queryMeterRunAnalysisMapData() {
		return null;
	}
    ...
    @ResponseBody
	public String downloadMeterRunAnalysisList() {
		return null;
	}
    ...
    @ResponseBody
	public String queryDrTotalAnalysisData() {
		return null;
	}
    ...
    @ResponseBody
	public String queryDrCurrentMeterData() {
		return null;
	}
    ...
    @ResponseBody
	public String queryDrMeterManageData() {
		return null;
	}
    ...
    @ResponseBody
	public String queryDrMeterRunAnalysisData() {
		return null;
	}
    ...
    @ResponseBody
	public String queryDrDealAdvise() {
		return null;
	}
}
