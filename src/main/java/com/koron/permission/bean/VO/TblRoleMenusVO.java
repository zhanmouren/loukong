...
public class TblRoleMenusVO extends TreeBean.Long{
	//菜单同级顺序
 ...
 //角色code
	 ...
	 * 设置分级ID
	 */
	public TblRoleMenusVO setId(java.lang.Integer id) {
		this.id = id;
		return this;
	}
	 ...
	 * 设置类型
	 */
	public TblRoleMenusVO setType(int type) {
		this.type = type;
		return this;
	}
	 ...
	 * 设置外键
	 */
	public TblRoleMenusVO setForeignkey(String foreignkey) {
