...
@RequestMapping(value = "/{tenantID}/zoneLossController")
public class ZoneLossController {
	...
	public String queryZoneWBLossData(@RequestBody QueryZoneWBLossDTO queryZoneWBLossDTO,
		...
		if (queryZoneWBLossDTO.getTimeType() == null) {
			...
			return msg.toJson();
		} else if (queryZoneWBLossDTO.getTimeType() < Constant.TIME_TYPE_M
				|| queryZoneWBLossDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			...
			return msg.toJson();
		} else if (queryZoneWBLossDTO.getZoneRank() != null && (queryZoneWBLossDTO.getZoneRank() < Constant.RANK_F
				|| queryZoneWBLossDTO.getZoneRank() > Constant.RANK_T)) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
		...
		try {
			ZoneWBLossVO data = ADOConnection.runTask(user.getEnv(), wbas, "queryZoneWBLossData", ZoneWBLossVO.class,
					queryZoneWBLossDTO);
			msg.setData(data);
		} catch (Exception e) {
	...
	@RequestMapping(value = "/queryWNWBReportList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryWNWBReportList(@RequestBody QueryWNWBReportListDTO queryWNWBReportListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO data = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBReportList", PageListVO.class,
					queryWNWBReportListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	 ...
	 * @return
	 */
	public MessageBean checkWNWBReportListParam(QueryWNWBReportListDTO queryWNWBReportListDTO,
			MessageBean<PageListVO> msg) {
		...
		} else if (queryWNWBReportListDTO.getTimeType() != null
				&& (queryWNWBReportListDTO.getTimeType() < Constant.TIME_TYPE_M
						|| queryWNWBReportListDTO.getTimeType() > Constant.TIME_TYPE_Y)) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
		} else if ((queryWNWBReportListDTO.getStartTime() != null && queryWNWBReportListDTO.getEndTime() != null)
				&& (queryWNWBReportListDTO.getStartTime() > queryWNWBReportListDTO.getEndTime())) {
			// 开始时间不能大于结束时间
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
	...
	@RequestMapping(value = "/downloadWNWBReport.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadWNWBReport(Integer id, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			// 查询报表
			WNWBReportDetailVO report = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBReportDetail",
					WNWBReportDetailVO.class, id);
			if (report == null)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			// 查询模板
			WNWBTReportDetailVO tReport = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBTReportDetail",
					WNWBTReportDetailVO.class, report.getTemplateId());
			...
			entity = ExportExcel.export("file", "static/excelTemplate/waterBalanceIWAEn.xlsx",
					"/excelTemplate/waterBalanceIWA.btl", data);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return entity;
	...
	@RequestMapping(value = "/deleteWNWBReport.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String deleteWNWBReport(Integer id, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			if (id != null) {
				ADOConnection.runTask(user.getEnv(), wbas, "deleteWNWBReport", Void.class, id);
			} else {
				msg.setCode(Constant.MESSAGE_INT_NULL);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/downloadWNWBReportList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadWNWBReportList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			// 参数校验
			MessageBean msg = checkWNWBReportListParam(qwnwbr,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qwnwbr.setPage(1);
			qwnwbr.setPageCount(Constant.DOWN_MAX_LIMIT);
			// 查询到导出数据结果
			PageListVO<List<WNWBReportListVO>> data = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBReportList",
					PageListVO.class, qwnwbr);
	...
	@RequestMapping(value = "/addWNWBReport.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String addWNWBReport(@RequestBody AddWNWBReportDTO addWNWBReportDTO,
		...
		try {
			ADOConnection.runTask(user.getEnv(), wbas, "addWNWBReport", Integer.class, addWNWBReportDTO);
	...
	@RequestMapping(value = "/updateWNWBReport.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String updateWNWBReport(@RequestBody AddWNWBReportDTO editWNWBReportDTO,
		...
		try {
			ADOConnection.runTask(user.getEnv(), wbas, "updateWNWBReport", Integer.class, editWNWBReportDTO);
	...
	@RequestMapping(value = "/queryWNWBReportDetail.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	@RequestMapping(value = "/queryWNWBReporFileList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryWNWBReporFileList(@RequestBody WNWBReportFileDTO wNWBReportFileDTO,
		...
		try {
			...
			List<WNWBReporFileListVO> lists = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBReporFileList",
					List.class, wNWBReportFileDTO);
			data.setData(lists);
		} catch (Exception e) {
	...
	@RequestMapping(value = "/deleteWNWBReporFile.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String deleteWNWBReporFile(Integer fileId, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			if (fileId != null) {
				ADOConnection.runTask(user.getEnv(), wbas, "deleteReportFileById", Void.class, fileId);
			} else {
				msg.setCode(Constant.MESSAGE_INT_NULL);
				msg.setDescription(Constant.MESSAGE_STRING_NULL);
			}
	...
	@RequestMapping(value = "/queryWNWBIndicatorData.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryWNWBIndicatorData(@RequestBody IndicatorDTO indicatorDTO,
		...
		try {
			@SuppressWarnings("unchecked")
			List<IndicatorVO> lists = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBIndicatorData", List.class,
					indicatorDTO);
			data.setData(lists);
		} catch (Exception e) {
			data.setCode(Constant.MESSAGE_INT_ERROR);
	...
	@RequestMapping(value = "/queryWNWBTReportList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryWNWBTReportList(@RequestBody QueryWNWBTReportListDTO queryWNWBTReportListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO data = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBTReportList", PageListVO.class,
					queryWNWBTReportListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	 ...
	 * @return
	 */
	public MessageBean checkWNWBTReportListParam(QueryWNWBTReportListDTO queryWNWBTReportListDTO,
			MessageBean<PageListVO> msg) {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/downloadWNWBReporTemplate.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadWNWBReporTemplate(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkWNWBTReportListParam(qwnwbtr,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qwnwbtr.setPage(1);
			...
			// 查询到导出数据结果
			PageListVO<List<WNWBTReportListVO>> data = ADOConnection.runTask(user.getEnv(), wbas,
					"queryWNWBTReportList", PageListVO.class, qwnwbtr);
			List<Map<String, String>> jsonArray = jsonValue.fromJson(titleInfos,
					new TypeToken<List<Map<String, String>>>() {
					}.getType());
			// 导出excel文件
	...
	@RequestMapping(value = "/deleteWNWBReporTemplate.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String deleteWNWBReporTemplate(Integer tId, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			if (tId != null) {
				ADOConnection.runTask(user.getEnv(), wbas, "deleteWNWBTReport", Void.class, tId);
			} else {
				msg.setCode(Constant.MESSAGE_INT_NULL);
				msg.setDescription(Constant.MESSAGE_STRING_NULL);
			}
	...
	@RequestMapping(value = "/addWNWBReporTemplate.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String addWNWBReporTemplate(@RequestBody AddWNWBTReportDTO addWNWBTReportDTO,
		...
		try {
			ADOConnection.runTask(user.getEnv(), wbas, "addWNWBTReport", Integer.class, addWNWBTReportDTO);
	...
	@RequestMapping(value = "/updateWNWBReporTemplate.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String updateWNWBReporTemplate(@RequestBody AddWNWBTReportDTO editWNWBTReportDTO,
		...
		try {
			ADOConnection.runTask(user.getEnv(), wbas, "updateWNWBTReport", Integer.class, editWNWBTReportDTO);
	...
	@RequestMapping(value = "/queryWNWBTReportDetail.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryWNWBTReportDetail(Integer id, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			if (id != null) { // 判断查看详情时，id是否为空
				WNWBTReportDetailVO report = ADOConnection.runTask(user.getEnv(), wbas, "queryWNWBTReportDetail",
						WNWBTReportDetailVO.class, id);
				data.setData(report);
			} else {
				data.setCode(Constant.MESSAGE_INT_NULL);
				data.setDescription(Constant.MESSAGE_STRING_NULL);
	...
	@RequestMapping(value = "/queryFZoneLossList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryFZoneLossList(@RequestBody QueryFZoneLossListDTO queryFZoneLossListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO data = ADOConnection.runTask(user.getEnv(), zlas, "queryFZoneLossList", PageListVO.class,
					queryFZoneLossListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	 ...
	 * @return
	 */
	public MessageBean checkFZoneLossListParam(QueryFZoneLossListDTO queryFZoneLossListDTO,
			MessageBean<PageListVO> msg) {
		if (queryFZoneLossListDTO.getTimeType() == null) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_NULL);
			msg.setDescription("时间粒度为空");
		} else if (queryFZoneLossListDTO.getTimeType() < Constant.TIME_TYPE_D
				|| queryFZoneLossListDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
			...
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
		} else if ((StringUtil.isNotEmpty(queryFZoneLossListDTO.getMinNrw())
				&& !com.koron.inwlms.util.StringUtil.isNumeric(queryFZoneLossListDTO.getMinNrw()))
				|| (StringUtil.isNotEmpty(queryFZoneLossListDTO.getMaxNrw())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryFZoneLossListDTO.getMaxNrw()))
				|| (StringUtil.isNotEmpty(queryFZoneLossListDTO.getMinWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryFZoneLossListDTO.getMinWl()))
				|| (StringUtil.isNotEmpty(queryFZoneLossListDTO.getMaxWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryFZoneLossListDTO.getMaxWl()))) {
			// 产销差范围输入错误
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("请输入数字类型的数据");
		} else if (StringUtil.isNotEmpty(queryFZoneLossListDTO.getMinNrw())
				&& StringUtil.isNotEmpty(queryFZoneLossListDTO.getMaxNrw())) {
			if (Double.parseDouble(queryFZoneLossListDTO.getMinNrw()) > Double
					.parseDouble(queryFZoneLossListDTO.getMaxNrw())) {
				// 产销差范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("产销差范围输入错误");
			}
		} else if (StringUtil.isNotEmpty(queryFZoneLossListDTO.getMinWl())
				&& StringUtil.isNotEmpty(queryFZoneLossListDTO.getMaxWl())) {
			if (Double.parseDouble(queryFZoneLossListDTO.getMinWl()) > Double
					.parseDouble(queryFZoneLossListDTO.getMaxWl())) {
				// 漏损量范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
	...
	@RequestMapping(value = "/downloadFZoneLossList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadFZoneLossList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkFZoneLossListParam(qfzlDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qfzlDTO.setPage(1);
			...
			// 查询到导出数据结果
			PageListVO<List<FZoneLossListVO>> data = ADOConnection.runTask(user.getEnv(), zlas, "queryFZoneLossList",
					PageListVO.class, qfzlDTO);
			List<Map<String, String>> jsonArray = jsonValue.fromJson(titleInfos,
					new TypeToken<List<Map<String, String>>>() {
					}.getType());
			// 导出excel文件
	...
	@RequestMapping(value = "/querySZoneLossList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String querySZoneLossList(@RequestBody QuerySZoneLossListDTO querySZoneLossListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO data = ADOConnection.runTask(user.getEnv(), zlas, "querySZoneLossList", PageListVO.class,
					querySZoneLossListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	 ...
	 * @return
	 */
	public MessageBean checkSZoneLossListParam(QuerySZoneLossListDTO querySZoneLossListDTO,
			MessageBean<PageListVO> msg) {
		if (querySZoneLossListDTO.getTimeType() == null) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_NULL);
			msg.setDescription("时间粒度为空");
		} else if (querySZoneLossListDTO.getTimeType() < Constant.TIME_TYPE_D
				|| querySZoneLossListDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
			...
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
		} else if ((StringUtil.isNotEmpty(querySZoneLossListDTO.getMinNrw())
				&& !com.koron.inwlms.util.StringUtil.isNumeric(querySZoneLossListDTO.getMinNrw()))
				|| (StringUtil.isNotEmpty(querySZoneLossListDTO.getMaxNrw())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(querySZoneLossListDTO.getMaxNrw()))
				|| (StringUtil.isNotEmpty(querySZoneLossListDTO.getMinWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(querySZoneLossListDTO.getMinWl()))
				|| (StringUtil.isNotEmpty(querySZoneLossListDTO.getMaxWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(querySZoneLossListDTO.getMaxWl()))) {
			// 产销差范围输入错误
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("请输入数字类型的数据");
		} else if (StringUtil.isNotEmpty(querySZoneLossListDTO.getMinNrw())
				&& StringUtil.isNotEmpty(querySZoneLossListDTO.getMaxNrw())) {
			if (Double.parseDouble(querySZoneLossListDTO.getMinNrw()) > Double
					.parseDouble(querySZoneLossListDTO.getMaxNrw())) {
				// 产销差范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("产销差范围输入错误");
			}
		} else if (StringUtil.isNotEmpty(querySZoneLossListDTO.getMinWl())
				&& StringUtil.isNotEmpty(querySZoneLossListDTO.getMaxWl())) {
			if (Double.parseDouble(querySZoneLossListDTO.getMinWl()) > Double
					.parseDouble(querySZoneLossListDTO.getMaxWl())) {
				// 漏损量范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("漏损水量范围输入错误");
			}
	...
	@RequestMapping(value = "/downloadSZoneLossList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadSZoneLossList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkSZoneLossListParam(qszlDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qszlDTO.setPage(1);
			...
			// 查询到导出数据结果
			PageListVO<List<SZoneLossListVO>> data = ADOConnection.runTask(user.getEnv(), zlas, "querySZoneLossList",
					PageListVO.class, qszlDTO);
			List<Map<String, String>> jsonArray = jsonValue.fromJson(titleInfos,
					new TypeToken<List<Map<String, String>>>() {
					}.getType());
			// 导出excel文件
	...
	@RequestMapping(value = "/queryDmaZoneLossList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryDmaZoneLossList(@RequestBody QueryDmaZoneLossListDTO QueryDmaZoneLossListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO data = ADOConnection.runTask(user.getEnv(), zlas, "queryDmaZoneLossList", PageListVO.class,
					QueryDmaZoneLossListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	 ...
	 * @return
	 */
	public MessageBean checkDmaZoneLossListParam(QueryDmaZoneLossListDTO QueryDmaZoneLossListDTO,
			MessageBean<PageListVO> msg) {
		if (QueryDmaZoneLossListDTO.getTimeType() == null) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_NULL);
			msg.setDescription("时间粒度为空");
		} else if (QueryDmaZoneLossListDTO.getTimeType() < Constant.TIME_TYPE_M
				|| QueryDmaZoneLossListDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
			...
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
		} else if ((StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMinNrw())
				&& !com.koron.inwlms.util.StringUtil.isNumeric(QueryDmaZoneLossListDTO.getMinNrw()))
				|| (StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMaxNrw())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(QueryDmaZoneLossListDTO.getMaxNrw()))
				|| (StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMinWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(QueryDmaZoneLossListDTO.getMinWl()))
				|| (StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMaxWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(QueryDmaZoneLossListDTO.getMaxWl()))) {
			// 产销差范围输入错误
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("请输入数字类型的数据");
		} else if (StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMinNrw())
				&& StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMaxNrw())) {
			if (Double.parseDouble(QueryDmaZoneLossListDTO.getMinNrw()) > Double
					.parseDouble(QueryDmaZoneLossListDTO.getMaxNrw())) {
				// 产销差范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("产销差范围输入错误");
			}
		} else if (StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMinWl())
				&& StringUtil.isNotEmpty(QueryDmaZoneLossListDTO.getMaxWl())) {
			if (Double.parseDouble(QueryDmaZoneLossListDTO.getMinWl()) > Double
					.parseDouble(QueryDmaZoneLossListDTO.getMaxWl())) {
				// 漏损量范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("漏损水量范围输入错误");
			}
	...
	@RequestMapping(value = "/downloadDmaZoneLossList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadDmaZoneLossList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkDmaZoneLossListParam(qdzlDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qdzlDTO.setPage(1);
			...
			// 查询到导出数据结果
			PageListVO<List<DmaZoneLossListVO>> data = ADOConnection.runTask(user.getEnv(), zlas,
					"queryDmaZoneLossList", PageListVO.class, qdzlDTO);
			List<Map<String, String>> jsonArray = jsonValue.fromJson(titleInfos,
					new TypeToken<List<Map<String, String>>>() {
					}.getType());
			// 导出excel文件
	...
	public String queryZonelocation(@RequestBody QueryZoneInfoDTO queryZoneInfoDTO,
		...
		if (StringUtil.isEmpty(queryZoneInfoDTO.getZoneNo())) {
			...
			return msg.toJson();
				...
				&& (queryZoneInfoDTO.getZoneType() < 1 || queryZoneInfoDTO.getZoneType() > 4)) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
		...
		try {
			PositionInfoVO data = ADOConnection.runTask(user.getEnv(), new GisZoneServiceImpl(),
					"queryZonePositionInfo", PositionInfoVO.class, queryZoneInfoDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	...
	public String queryZonedetail(@RequestBody QueryZoneInfoDTO queryZoneInfoDTO,
		...
		try {
			ZoneDetailInfoVO data = ADOConnection.runTask(user.getEnv(), new GisZoneServiceImpl(),
					"queryZoneDetailInfo", ZoneDetailInfoVO.class, queryZoneInfoDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	...
	@RequestMapping(value = "/queryVSZoneList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryVSZoneList(@RequestBody QueryVSZoneListDTO queryVSZoneListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		// try{
		PageListVO<List<VSZoneListVO>> data = ADOConnection.runTask(user.getEnv(), vzlas, "queryVSZoneList",
				PageListVO.class, queryVSZoneListDTO);
		msg.setData(data);
		// }catch(Exception e){
		// msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
		// msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	...
	public MessageBean checkVSZoneListParam(QueryVSZoneListDTO queryVSZoneListDTO, MessageBean<PageListVO> msg) {
		if (queryVSZoneListDTO.getTimeType() == null) {
			...
			msg.setCode(Constant.MESSAGE_INT_NULL);
			msg.setDescription("时间粒度为空");
		} else if (queryVSZoneListDTO.getTimeType() < Constant.TIME_TYPE_D
				|| queryVSZoneListDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
			...
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
		} else if ((StringUtil.isNotEmpty(queryVSZoneListDTO.getMinNrw())
				&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVSZoneListDTO.getMinNrw()))
				|| (StringUtil.isNotEmpty(queryVSZoneListDTO.getMaxNrw())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVSZoneListDTO.getMaxNrw()))
				|| (StringUtil.isNotEmpty(queryVSZoneListDTO.getMinWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVSZoneListDTO.getMinWl()))
				|| (StringUtil.isNotEmpty(queryVSZoneListDTO.getMaxWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVSZoneListDTO.getMaxWl()))) {
			// 产销差范围输入错误
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("请输入数字类型的数据");
		} else if (StringUtil.isNotEmpty(queryVSZoneListDTO.getMinNrw())
				&& StringUtil.isNotEmpty(queryVSZoneListDTO.getMaxNrw())) {
			if (Double.parseDouble(queryVSZoneListDTO.getMinNrw()) > Double
					.parseDouble(queryVSZoneListDTO.getMaxNrw())) {
				// 产销差范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("产销差范围输入错误");
			}
		} else if (StringUtil.isNotEmpty(queryVSZoneListDTO.getMinWl())
				&& StringUtil.isNotEmpty(queryVSZoneListDTO.getMaxWl())) {
	...
	@RequestMapping(value = "/downloadVSZoneHstList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadVSZoneHstList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkVSZoneListParam(qvszlDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qvszlDTO.setPage(1);
	...
	@RequestMapping(value = "/queryVCZoneList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryVCZoneList(@RequestBody QueryVCZoneListDTO queryVCZoneListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO<List<VCZoneListVO>> data = ADOConnection.runTask(user.getEnv(), vzlas, "queryVCZoneList",
					PageListVO.class, queryVCZoneListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	...
	public MessageBean checkVCZoneListParam(QueryVCZoneListDTO queryVCZoneListDTO, MessageBean<PageListVO> msg) {
		if (queryVCZoneListDTO.getTimeType() == null) {
			...
			msg.setCode(Constant.MESSAGE_INT_NULL);
			msg.setDescription("时间粒度为空");
		} else if (queryVCZoneListDTO.getTimeType() < Constant.TIME_TYPE_D
				|| queryVCZoneListDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
			...
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
		} else if ((StringUtil.isNotEmpty(queryVCZoneListDTO.getMinNrw())
				&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVCZoneListDTO.getMinNrw()))
				|| (StringUtil.isNotEmpty(queryVCZoneListDTO.getMaxNrw())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVCZoneListDTO.getMaxNrw()))
				|| (StringUtil.isNotEmpty(queryVCZoneListDTO.getMinWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVCZoneListDTO.getMinWl()))
				|| (StringUtil.isNotEmpty(queryVCZoneListDTO.getMaxWl())
						&& !com.koron.inwlms.util.StringUtil.isNumeric(queryVCZoneListDTO.getMaxWl()))) {
			// 产销差范围输入错误
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("请输入数字类型的数据");
		} else if (StringUtil.isNotEmpty(queryVCZoneListDTO.getMinNrw())
				&& StringUtil.isNotEmpty(queryVCZoneListDTO.getMaxNrw())) {
			if (Double.parseDouble(queryVCZoneListDTO.getMinNrw()) > Double
					.parseDouble(queryVCZoneListDTO.getMaxNrw())) {
				// 产销差范围输入错误
				msg.setCode(Constant.MESSAGE_INT_PARAMS);
				msg.setDescription("产销差范围输入错误");
			}
		} else if (StringUtil.isNotEmpty(queryVCZoneListDTO.getMinWl())
				&& StringUtil.isNotEmpty(queryVCZoneListDTO.getMaxWl())) {
	...
	@RequestMapping(value = "/downloadVCZoneList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadVCZoneList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkVCZoneListParam(qvczlDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qvczlDTO.setPage(1);
	...
	@RequestMapping(value = "/addVCZone.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String addVCZone(@RequestBody AddVCZoneDTO addVCZoneDTO, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		// TODO 判断合并分区是否存在
		try {
			ADOConnection.runTask(user.getEnv(), vzlas, "addVCZone", Void.class, addVCZoneDTO);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_DELERROR);
			msg.setDescription(Constant.MESSAGE_STRING_DELERROR);
		}
	...
	@RequestMapping(value = "/deleteVCZone.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String deleteVCZone(String vZoneNo, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			ADOConnection.runTask(user.getEnv(), vzlas, "deleteVCZone", Void.class, vZoneNo);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_DELERROR);
			msg.setDescription(Constant.MESSAGE_STRING_DELERROR);
		}
	 ...
	 * 查询全网漏点专题图（调用gis接口）
	 * 
	 * @param thematicMapType
	 *            专题图类型（0：管径，1：漏损现象，2：处理情况，3：漏点密度）
	 * @return
	 */
	@RequestMapping(value = "/queryWNLeakMapList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	 ...
	 * @return
	 */
	@RequestMapping(value = "/queryWNLeakList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	@RequestMapping(value = "/queryZoneIndicatorDic.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryZoneIndicatorDic(Integer zoneType, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			List<ZoneIndicatorDicVO> lists = ADOConnection.runTask(user.getEnv(), zlas, "queryZoneIndicatorDic",
					List.class, zoneType);
			msg.setData(lists);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_DELERROR);
	...
	public String queryZoneThematicValue(@RequestBody ZoneThematicValueDTO zoneThematicValueDTO,
		...
		if (zoneThematicValueDTO.getItemCode() == null) {
			...
			msg.setDescription("开始时间大于结束时间");
			return msg.toJson();
		} else if (zoneThematicValueDTO.getZoneType() != null && (zoneThematicValueDTO.getZoneType() < Constant.RANK_F
				|| zoneThematicValueDTO.getZoneType() > Constant.RANK_T)) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("分区等级数值错误");
			return msg.toJson();
	...
	public String queryZoneIndicatorList(@RequestBody QueryZoneIndicatorListDTO queryZoneIndicatorListDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO<List<Map<Object, Object>>> data = ADOConnection.runTask(user.getEnv(), zlas,
					"queryZoneIndicatorList", PageListVO.class, queryZoneIndicatorListDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	 ...
	 * @return
	 */
	public MessageBean checkZoneIndicatorListParam(QueryZoneIndicatorListDTO queryZoneIndicatorListDTO,
			MessageBean<PageListVO> msg) {
		if (queryZoneIndicatorListDTO.getZoneType() == null) {
			...
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("开始时间大于结束时间");
		} else if (queryZoneIndicatorListDTO.getZoneType() != null
				&& (queryZoneIndicatorListDTO.getZoneType() < Constant.RANK_F
						|| queryZoneIndicatorListDTO.getZoneType() > Constant.RANK_T)) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("分区等级数值错误");
	...
	@RequestMapping(value = "/downloadZoneIndicatorList.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public HttpEntity<?> downloadZoneIndicatorList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkZoneIndicatorListParam(qzilDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			qzilDTO.setPage(1);
			...
			// 查询到导出数据结果
			PageListVO<List<Map<Object, Object>>> data = ADOConnection.runTask(user.getEnv(), zlas,
					"queryZoneIndicatorList", PageListVO.class, qzilDTO);
			List<Map<String, String>> jsonArray = jsonValue.fromJson(titleInfos,
					new TypeToken<List<Map<String, String>>>() {
					}.getType());
			// 导出excel文件
	...
	@RequestMapping(value = "/queryWBIndicatorData.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryWBIndicatorData(@RequestBody IndicatorDTO indicatorDTO,
		...
		if (indicatorDTO.getTimeType() == null) {
			...
			msg.setDescription("时间粒度为空");
			return msg.toJson();
		} else if (indicatorDTO.getTimeType() < Constant.TIME_TYPE_M
				|| indicatorDTO.getTimeType() > Constant.TIME_TYPE_Y) {
			// 传参数值不正确
			msg.setCode(Constant.MESSAGE_INT_PARAMS);
			msg.setDescription("时间粒度数值错误");
			return msg.toJson();
		...
		try {
			List<IndicatorVO> data = ADOConnection.runTask(user.getEnv(), wbas, "queryWBIndicatorData", List.class,
					indicatorDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
	...
	public String updateLeakageExponent(String value, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			ADOConnection.runTask(user.getEnv(), lpss, "updateLeakageExponent", Void.class, value);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_EDITERROR);
			msg.setDescription(Constant.MESSAGE_STRING_EDITERROR);
		}
	 ...
	 * 分页查询合理夜晚使用量列表信息方法
	 *
	 * @param legitimateNightUseListDTO
	 *            滤水厂回用水数据列表查询DTO
	 * @return
	 */
	...
	public String queryLegitimateNightUseList(@RequestBody LegitimateNightUseDTO lnuDTO,
		...
		if (msg.getCode() != 0)
			return msg.toJson();
		try {
			PageListVO data = ADOConnection.runTask(user.getEnv(), lpss, "queryLegitimateNightUseList",
					PageListVO.class, lnuDTO);
			msg.setData(data);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
	...
	public HttpEntity<?> downloadLegitimateNightUseList(@RequestParam String objValue, @RequestParam String titleInfos,
		...
		try {
			...
			MessageBean msg = checkLegitimateNightUseListParam(lnuDTO,
					MessageBean.create(0, Constant.MESSAGE_STRING_SUCCESS, PageListVO.class));
			if (msg.getCode() != 0)
				return new HttpEntity<Integer>(Constant.MESSAGE_INT_NULL);
			lnuDTO.setPage(1);
			...
			// 查询到导出数据结果
			PageListVO<List<LegitimateNightUseVO>> data = ADOConnection.runTask(user.getEnv(), lpss,
					"queryLegitimateNightUseList", PageListVO.class, lnuDTO);
			List<Map<String, String>> jsonArray = jsonValue.fromJson(titleInfos,
					new TypeToken<List<Map<String, String>>>() {
					}.getType());
			// 导出excel文件
	 ...
	 * 更新合理夜晚使用量信息
	 *
	 * @param legitimateNightUseEditDTO
	 *            滤水厂回用水数据更新DTO
	 * @return
	 */
	...
	public String updateLegitimateNightUse(@RequestBody LegitimateNightUseEditDTO legitimateNightUseEditDTO,
		...
		try {
			ADOConnection.runTask(user.getEnv(), lpss, "updateLegitimateNightUse", Void.class,
					legitimateNightUseEditDTO);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_SELECTERROR);
			msg.setDescription(Constant.MESSAGE_STRING_SELECTERROR);
		}
	...
	@RequestMapping(value = "/queryZoneHstIndicatorDic.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryZoneHstIndicatorDic(Integer zoneType, @StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		try {
			List<ZoneIndicatorDicVO> lists = ADOConnection.runTask(user.getEnv(), zlas, "queryZoneHstIndicatorDic",
					List.class, zoneType);
			msg.setData(lists);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_DELERROR);
	...
	@RequestMapping(value = "/queryBurstLeakAnalysis.htm", method = RequestMethod.POST, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryBurstLeakAnalysis(@StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		MessageBean<List> msg = MessageBean.create(Constant.MESSAGE_INT_SUCCESS, Constant.MESSAGE_STRING_SUCCESS,
				List.class);
		try {
			List<BurstLeakAnalysisVO> lists = ADOConnection.runTask(user.getEnv(), zlas, "queryBurstLeakAnalysis",
					List.class, "");
			msg.setData(lists);
		} catch (Exception e) {
			msg.setCode(Constant.MESSAGE_INT_DELERROR);
	...
	@RequestMapping(value = "/queryBurstLeakById.htm", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
	...
	public String queryBurstLeakById(String id,@StaffAttribute(Constant.LOGIN_USER) UserVO user) {
		...
		if(StringUtil.isEmpty(id)) {
			// 参数不正确
			msg.setCode(Constant.MESSAGE_INT_NULL);
			msg.setDescription("漏点id为空");
		}
		try {
			LeakDetailsVO lists = ADOConnection.runTask(user.getEnv(), zlas, "queryBurstLeakById",
					LeakDetailsVO.class, id);
			msg.setData(lists);
		} catch (Exception e) {
